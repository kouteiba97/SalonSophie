...
/**
 * The atelier's own gate.
 *
 * The console layout above already established that someone is signed in; this adds the one
 * restriction the atelier carries. `gown_reservations_read` is limited to owner and reception,
 * so a stylist reaching this URL would see an empty console — saying why beats showing them
 * nothing and letting them think it is broken.
 *
 * Still a courtesy, not the boundary. RLS refuses the rows whatever this file does.
 */
