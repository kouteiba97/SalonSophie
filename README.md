...
supabase/migrations/              28 migrations — schema, RLS, seed, booking, atelier, inbox, grants
...
**396 unit tests**, **56 Playwright tests**, production build green.
...
All 28 migrations have been applied to a live Supabase project in `eu-west-3` (Paris — the closest
